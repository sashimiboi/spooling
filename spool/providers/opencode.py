...
from spool.config import OPENCODE_DB
from spool.parser import ParsedMessage, ParsedSession, ToolCallDetail, _summarize_tool_input
        ...
        try:
            ...
            for s in session_rows:
                ...
                session = ParsedSession(
                    ...
                    claude_version=s["version"] or None,
                    model=model,
